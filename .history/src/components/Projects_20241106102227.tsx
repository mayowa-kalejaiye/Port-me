...
const projects = [
  {
    ...
    description: "A full-featured e-commerce platform built with Django - backend and HTML, CSS & Javascript - frontend, featuring real-time inventory management and secure payment processing.",
    image: "https://images.unsplash.com/photo-1557821552-17105176677c?w=800&h=600&fit=crop",
    tags: ["Django", "TypeScript", "Stripe", "Tailwind CSS"],
