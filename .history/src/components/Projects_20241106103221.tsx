...
const projects = [
  ...
  {
    title: "Moodify",
    description: "Moodify is a dynamic, AI-powered app that adapts to user emotions by providing music recommendations and mood-based analytics. Developed with React for seamless interactivity and D3.js for immersive, real-time data visualization.",
    image: mood,
    tags: ["Django", "D3.js", "Machine Learning", "Node.js", "Express"],
    liveUrl: "https://your-moodify-app-link.com",
    githubUrl: "https://github.com/your-username/moodify"
  },
  {
