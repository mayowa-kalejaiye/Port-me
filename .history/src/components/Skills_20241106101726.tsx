...
const skills = [
  {
    ...
    items: ["React", "TypeScript", "Next.js", "TaCSS", "Redux"]
  },
  {
    category: "Backend Development",
    icon: <Server className="w-6 h-6" />,
    items: ["Node.js", "Python", "PostgreSQL", "Express", "Django"]
  },
  {
  ...
  },
  {
    ...
    items: ["Figma", "Adobe XD", "Sketch", "Prototyping", "Wire-framing"]
  },
  {
    category: "Database",
    icon: <Database className="w-6 h-6" />,
    items: ["MongoDB", "MySQL", "Redis", "Firebase", "Supabase"]
  },
  {
