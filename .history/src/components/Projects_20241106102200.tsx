...
const projects = [
  {
    ...
    description: "A full-featured e-commerce platform built with Django - backend and HTML, CSS & j, featuring real-time inventory management and secure payment processing.",
