...
const projects = [
  {
    ...
    description: "A full-featured e-commerce platform built with Django - backend and HTML, CSS & Javascript - frontend, future improvement - featuring real-time inventory management and secure payment processing.",
