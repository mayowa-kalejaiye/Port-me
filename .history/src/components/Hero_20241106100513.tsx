  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        >
          <img 
            src="https://www.istockphoto.com/photo/contact-icon-3d-render-illustration-gm1432561113-474766545?utm_campaign=srp_photos_bottom&utm_content=https%3A%2F%2Funsplash.com%2Fs%2Fphotos%2Fprofile-default&utm_medium=affiliate&utm_source=unsplash&utm_term=profile+default%3A%3Aaffiliate-collections%3Acontrol" 
            alt="Profile"
        ...
        >
          ...
          <SocialLink href="mailto:kalejaiyemayowa3@gmail.com" icon={<Mail />} />
        </motion.div>
