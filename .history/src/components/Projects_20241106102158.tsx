...
const projects = [
  {
    ...
    description: "A full-featured e-commerce platform built with Django - backend and HTML, CSS & , featuring real-time inventory management and secure payment processing.",
