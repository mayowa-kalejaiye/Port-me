...
const projects = [
  {
    ...
    description: "A full-featured e-commerce platform built with Django - backend and HTML, c, featuring real-time inventory management and secure payment processing.",
